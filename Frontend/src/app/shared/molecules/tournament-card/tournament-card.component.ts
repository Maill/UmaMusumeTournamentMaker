...
import { TournamentType, TournamentStatus } from '../../types/tournament.types';
        ...
        <div class="stats-grid">
          <div class="stat-item">
            ...
            <div class="stat-content">
              ...
              <span class="stat-label">{{ tournament.playersCount === 1 ? 'Player' : 'Players' }}</span>
            </div>
          </div>
